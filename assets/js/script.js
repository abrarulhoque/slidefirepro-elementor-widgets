...
(function($) {
    ...
    class SlidefireCategoryNavigation {
        ...
        getVisibleItems() {
            ...
            return Array.from(this.items).filter(item => {
                const itemRect = item.getBoundingClientRect();
                return itemRect.left >= wrapperRect.left && itemRect.right <= wrapperRect.right;
            });
        }
    }
    ...
    if (typeof elementorFrontend !== 'undefined') {
        elementorFrontend.hooks.addAction('frontend/element_ready/slidefire_category_navigation.default', function($scope) {
